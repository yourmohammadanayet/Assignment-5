...
function Hero() {
  return (
    <section className="bg-white">
      ...
      <div className="mx-auto mt-[96px] hidden h-[420px] max-w-[1216px] grid-cols-12 gap-8 lg:grid">
        ...
        <div className="col-span-5 flex h-[420px] items-center justify-center">
          <div className="relative flex h-[350px] w-[350px] items-center justify-center">
            ...
            <div className="absolute -left-6 -top-6 h-56 w-56 rounded-full bg-white/25 blur-3xl"></div>

            <div className="absolute -bottom-6 -right-6 h-56 w-56 rounded-full bg-white/25 blur-3xl"></div>
      ...
      {/* Mobile Hero */}
      <div className="flex flex-col items-center gap-[11.3px] px-5 pb-10 pt-[31.25px] lg:hidden">
        ...
        <p className="max-w-[384px] text-center text-[14px] font-normal leading-[22.75px] text-[#4B5563]">
        ...
        <div className="flex w-full max-w-[350px] items-center justify-center gap-3 pt-[12.7px]">
          <a
            href="#technologies"
            className="brand-gradient flex h-10 w-[168px] items-center justify-center rounded-lg text-[12px] font-normal leading-4 text-white shadow-sm"
          >
            Explore Technologies
          </a>
          ...
          <a
            href="#about"
            className="flex h-[42px] w-[170px] items-center justify-center rounded-lg border border-[#E5E7EB] bg-white text-[12px] font-normal leading-4 text-[#374151]"
          >
            Learn More
          </a>
        </div>

        <div className="relative flex h-[296px] w-[264px] items-center justify-center pt-[20.7px]">

          <div className="absolute inset-x-0 bottom-0 top-[20.7px] rounded-full bg-gradient-to-br from-pink-300/20 to-purple-300/20 blur-[20px]"></div>

          <img
            src={heroImage}
            alt="Dev Stack technology illustration"
            className="relative h-[299px] w-[327px] max-w-none object-cover"
          />
